...
// Enhanced FormProvider that doesn't automatically create a form element
// This prevents the invalid nesting of forms that was causing DOM errors
const Form = ({ children, ...props }: React.ComponentPropsWithoutRef<typeof FormProvider>) => {
  // Simple wrapper around FormProvider without adding a form element
  return (
    <FormProvider {...props}>
      {children}
    </FormProvider>
...
const useFormField = () => {
  ...
  // If contexts aren't available, provide safe fallbacks
  ...
  try {
    ...
    const id = itemContext?.id || "fallback-id"
